...
import { SalesforceApiContactDto } from './salesforce-api.contact.dto';

/**
 * TODO
 * - create base abstract class for mappers
 */
export class SalesforceApiContactMapper {
  public static toDomain(dto: SalesforceApiContactDto): Contact {
